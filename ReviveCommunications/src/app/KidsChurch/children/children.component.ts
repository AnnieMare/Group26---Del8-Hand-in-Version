...
export class ChildrenComponent implements OnInit {
  ...
  constructor(private sidebarService: NbSidebarService, private toastrService: NbToastrService,
    ...
    private loginService: LoginService, private formbuilder: FormBuilder, private memberService: MembersService)
    {
  ...
  ngOnInit()
  {
    ...
    if(!localStorage.getItem("accessToken")){
        ...
        this.loginService.getUserDetails(this.session).subscribe(res =>{
          this.Person = res;
          this.kidschurchService.getMyChildren(this.Person)
          .subscribe( x=>{  
            this.myChildren = x;
            ...
            {
              this.NoChildren = "No children are registered yet."
            }
            }
            )
  ...
  // getMyChildren(){
  //   this.kidschurchService.getMyChildren(this.Person).subscribe( x=>{
  //     this.myChildren = x;
  //     console.log(x)
  //   })
  // }
