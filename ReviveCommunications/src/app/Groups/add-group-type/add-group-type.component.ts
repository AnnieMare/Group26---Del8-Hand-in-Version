...
export class AddGroupTypeComponent implements OnInit {
  ...
  constructor(private router: Router, private service: GrouptypeService, private memberService: MembersService, private toastrService:NbToastrService, private dialogService:NbDialogService, private formBuilder:FormBuilder, private sidebarService: NbSidebarService, private loginService:LoginService) {
