...
export class GroupTransferComponent implements OnInit {
  ...
  constructor(private OrgStructPosService: OrganisationalStructurePositionService,
    ...
    private toastrService: NbToastrService , private memberService: MembersService,
  ...
  ngOnInit(): void {
    ...
    this.groupService.memberByID(this.id).subscribe(z => {
      this.members = z;
   ...
   checkGroups()
   {
     this.groupService.membersGroups(this.id).subscribe(data=> {this.MemberGroups = data;
       console.log(this.MemberGroups);
        if(data[0].Group)
        {
          this.PersonForm.controls.group1.setValue(data[0].Group);
          this.PersonGroup1 = data[0].PersonGroup;
        ...
        if(data[1].Group)
        {
          ...
          this.PersonGroup2 = data[1].PersonGroup;
        }
        else{
          this.PersonForm.controls.group2.disable();
        }
  ...
  AssignPosition(form)
  {
    ...
    form.personGroup1 = this.PersonGroup1;
    form.personGroup2 = this.PersonGroup2;
    form.personGroup3 = this.PersonGroup3;
    var data ={form: form, PersonID: this.id}
    this.groupService.transferGroups(data).subscribe(z=>{
      console.log(data)
