...
@Component({
  selector: 'app-view-group-type',
  templateUrl: './view-group-type.component.html',
  styleUrls: ['./view-group-type.component.scss']
})
export class ViewGroupTypeComponent implements OnInit {
...
GroupTypeU: any;
  ...
  constructor(private service: GrouptypeService, private memberService: MembersService, private sidebarService: NbSidebarService, private router: Router, private loginService:LoginService,  private toastrService: NbToastrService) { }
  ...
  onDelete (GroupType)
  {
    ...
    location.reload();
    this.SuccessMessage('top-right','danger');
  }
