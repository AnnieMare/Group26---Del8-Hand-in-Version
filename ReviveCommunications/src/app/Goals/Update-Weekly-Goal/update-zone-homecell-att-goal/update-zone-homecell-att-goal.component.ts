...
@Component({
  selector: 'app-update-zone-homecell-att-goal',
  templateUrl: './update-zone-homecell-att-goal.component.html',
  styleUrls: ['./update-zone-homecell-att-goal.component.scss']
})
export class UpdateZoneHomecellAttGoalComponent implements OnInit {
  ...
  if(!localStorage.getItem("accessToken")){
    ...
    this.GoalsService.getzHCOverseer().subscribe(data=>{
    ...
    updateZoneHomecellAttendanceGoalForm(form) {
      ...
      this.GoalsService.updateZoneHomecellAttGoal(data).subscribe(x =>{
        if(x == "Zone Homecell Attendance goal was updated successfully.")
        {
          this.Message = x;
          this.displayMessage('top-right', 'success');
          this.ZoneHomecellAttendance.reset();
        }
        else
        {
          this.Message = x;
