...
@Component({
  selector: 'app-update-nmo-goal',
  templateUrl: './update-nmo-goal.component.html',
  styleUrls: ['./update-nmo-goal.component.scss']
})
export class UpdateNMOGoalComponent implements OnInit {
  ...
  if(!localStorage.getItem("accessToken")){
    ...
    updateNewMemberOrientationGoalForm(form) {
      ...
      this.GoalsService.updateNMOGoal(data).subscribe(x =>{
        if(x == "New Member Oriantation monthly goal was updated successfully.")
        {
          this.Message = x;
