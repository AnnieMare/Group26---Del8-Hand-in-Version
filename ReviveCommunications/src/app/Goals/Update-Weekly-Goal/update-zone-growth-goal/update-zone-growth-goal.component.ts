...
@Component({
  selector: 'app-update-zone-growth-goal',
  templateUrl: './update-zone-growth-goal.component.html',
  styleUrls: ['./update-zone-growth-goal.component.scss']
})
export class UpdateZoneGrowthGoalComponent implements OnInit {
  ZoneGrowth: any;
  ...
  if(!localStorage.getItem("accessToken")){
    ...
    updateZoneGrowthGoalForm(form) {
      ...
      this.GoalsService.updateZoneGrowthGoal(data).subscribe(x =>{
        if(x == "Zone growth goal was updated successfully.")
        {
          this.Message = x;
