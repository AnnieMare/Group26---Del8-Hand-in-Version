...
@Component({
  selector: 'app-update-structure-growth-goal',
  templateUrl: './update-structure-growth-goal.component.html',
  styleUrls: ['./update-structure-growth-goal.component.scss']
})
export class UpdateStructureGrowthGoalComponent implements OnInit {
  StructureGrowth: any;
  Structure: any;
  Person:any;
	  session:any;
  ...
  if(!localStorage.getItem("accessToken")){
    ...
    updateStructureGrowthGoalForm(form) {
      ...
      this.GoalsService.updateStructureGrowthGoal(data).subscribe(x =>{
        if(x == "Structure Growth Goal was updated successfully.")
        {
          this.Message = x;
