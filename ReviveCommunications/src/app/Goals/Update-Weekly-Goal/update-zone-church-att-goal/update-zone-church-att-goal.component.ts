...
@Component({
  selector: 'app-update-zone-church-att-goal',
  templateUrl: './update-zone-church-att-goal.component.html',
  styleUrls: ['./update-zone-church-att-goal.component.scss']
})
export class UpdateZoneChurchAttGoalComponent implements OnInit {
  ...
  if(!localStorage.getItem("accessToken")){
    ...
    updateZoneChruchAttGoalForm(form) {
      ...
      this.GoalsService.updateZoneChurchAttGoal(data).subscribe(x =>{
        if(x == "Zone church attendance was updated successfully.")
        {
          this.Message = x;
