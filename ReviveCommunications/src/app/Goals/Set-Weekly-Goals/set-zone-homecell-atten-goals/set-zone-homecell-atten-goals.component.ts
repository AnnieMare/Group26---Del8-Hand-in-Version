...
@Component({
  selector: 'app-set-zone-homecell-atten-goals',
  templateUrl: './set-zone-homecell-atten-goals.component.html',
  styleUrls: ['./set-zone-homecell-atten-goals.component.scss']
})
export class SetZoneHomecellAttenGoalsComponent implements OnInit {
              ...
              },
 {
  ...
  addZoneHomecellAttendanceGoalForm(form) {
    ...
    this.GoalsService.setZoneHomecellAttGoal(data).subscribe(x =>{
      if(x == "Zone Homecell Attendance Goal was set successfully.")
      {
        this.Message = x;
