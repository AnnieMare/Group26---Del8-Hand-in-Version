...
@Component({
  selector: 'app-set-zone-church-atten-goals',
  templateUrl: './set-zone-church-atten-goals.component.html',
  styleUrls: ['./set-zone-church-atten-goals.component.scss']
})
export class SetZoneChurchAttenGoalsComponent implements OnInit {
  ...
  constructor(private router: Router, private GoalsService: GoalsServiceService,private formBuilder: FormBuilder, private sidebarService: NbSidebarService,
      private toastrService: NbToastrService, private memberService: MembersService ,private dialogService: NbDialogService, private loginService:LoginService) {
  ...
  ngOnInit(): void {
    ...
    this.GoalsService.getZoneOverseer().subscribe(data=>{
  ...
  addZoneChruchAttGoalForm(form) {
    ...
    this.GoalsService.setZoneChurchAttGoal(data).subscribe(x =>{
      if(x == "Zone Church Attendance Goal was set successfully.")
      {
        this.Message = x;
        this.displayMessage('top-right', 'success');
        this.ZoneChurchAttendance.reset();
      }
      else
      {
        this.Message = x;
