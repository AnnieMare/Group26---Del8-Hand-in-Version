...
import { NbToastrService, NbDialogService, NbMenuItem, NbSidebarService, NbDateService } from '@nebular/theme';
...
@Component({
  selector: 'app-set-church-atten-goals',
  templateUrl: './set-church-atten-goals.component.html',
  styleUrls: ['./set-church-atten-goals.component.scss']
})
export class SetChurchAttenGoalsComponent implements OnInit {
  ...
  constructor(private router: Router, private GoalsService: GoalsServiceService,private formBuilder: FormBuilder, private sidebarService: NbSidebarService,
      private toastrService: NbToastrService ,private dialogService: NbDialogService, private loginService:LoginService, private memberService: MembersService,
  ...
  addChurchAttGoalForm(form) {
    ...
    this.GoalsService.setChurchAttGoal(data).subscribe(x =>{
      if(x == "Weekly Church Attendance goal was set successfully.")
      {
        this.Message = x;
