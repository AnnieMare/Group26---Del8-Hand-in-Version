...
export class KidsChurchService {
  ...
  getChildByParentID()
  {
    return this.http.get('https://localhost:44390/api/KidsChurch/getcheckInChildRequestConfirm')
  }
  getChildByParent()
  {
    return this.http.get('https://localhost:44390/api/KidsChurch/getsignOutChildRequestConfirm')
  }

  ChildCheckIn(childID)
  {
    return this.http.post('https://localhost:44390/api/KidsChurch/checkInChild',childID, httpOptions)
