...
export class MessageService {
  ...
  constructor(private http: HttpClient,
    ...
    sendInvitation(inv){
      return this.http.post<any>(this.SERVER_URL + "api/Messages/SendInvitation", inv)
    }
    ...
    getCalenderInvitations(p){
      console.log(p)
      return this.http.post(this.SERVER_URL + "api/Messages/retrieveCalenderInvitations?pp=" + p , p)
    }
