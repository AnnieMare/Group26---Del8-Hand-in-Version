...
import { NbSidebarService, NbToastrService, NbMenuItem, NbDateService } from '@nebular/theme';
...
EndDate
   onClick(form){
    this.service.getDiscData(form).subscribe(x =>{
      this.Data = x;
      console.log(x)
      this.disc = x['Data'].map(o => o.Discipleship);
