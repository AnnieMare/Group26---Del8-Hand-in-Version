...
export class HomeComponent {
  ...
  calendarOptions: CalendarOptions = {
    ...
    {
      alert(arg.event.title + " on " + arg.event.startStr)
    }
     };
     events: any[] = [];
...
Announcements: any;
    ...
    if(!localStorage.getItem("accessToken")){
      ...
      this.session ={"SessionID": localStorage.getItem("accessToken")}
        this.loginService.getUserDetails(this.session).subscribe(res =>{
          this.Person = res;
          this.service.getCalenderInvitations(this.Person.PersonID).subscribe(x => {
            let Invitations = x;
           console.log(x)
           this.calendarOptions.events = Invitations;
       });
        ...
        this.Announcements = x;
          ...
          if(this.Person.OrgIndivPos == "Senior Pastor")
          {
            ...
            },
            {
              ...
              url: 'http://localhost:8080/User%20Manual.html'
            },
          ];
          }
  ...
  loadCalenderData(){
    var id = this.Person.PersonID;
    this.service.getCalenderInvitations(id).subscribe(x => {
       let Invitations = x;
      console.log(x)
      this.calendarOptions.events = Invitations;
  });
