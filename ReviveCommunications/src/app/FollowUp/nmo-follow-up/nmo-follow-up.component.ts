...
this.dialogService.open(ViewMemberDialogComponent, {
  ...
  ngOnInit(): void {
    ...
    this.NMOService.getNMO().subscribe(data=> {this.NMO = data;
      ...
      this.NMOService.getNMOProgress().subscribe(data=> {this.NMOProgress = data;
        ...
        //Assign NMO progress to array for chart
         this.pieChartData[0] = this.NMOProgress.Completed;
         this.pieChartData[1] = this.NMOProgress.Remaining;
         this.TotalFollowUps = this.NMOProgress.Completed + this.NMOProgress.Remaining;
        //if no NMO's are remaining on form load
  ...
  FollowedUp(selectedNMO)
  {
    console.log(selectedNMO)
    var data = { NMOID : selectedNMO, PersonID: this.Person.PersonID};
  ...
  NoAnswer(selectedNMO)
  {
    var data = { NMOID : selectedNMO, PersonID: this.Person.PersonID};

    this.NMOService.FollowUpNoAnswer(selectedNMO).subscribe(x=> {
