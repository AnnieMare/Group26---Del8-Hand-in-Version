...
this.dialogService.open(ViewMemberDialogComponent, {
    ...
    this.leaderService.getLeaders().subscribe(data=> {
      ...
      this.leaderService.getLeaderProgress().subscribe(data=> {this.LeaderProgress = data;
        //Assign leader progress to array for chart
         this.pieChartData[0] = this.LeaderProgress.Completed;
         this.pieChartData[1] = this.LeaderProgress.Remaining;
        this.TotalFollowUps = this.LeaderProgress.Completed + this.LeaderProgress.Remaining;
  ...
  {
    var data = { LeaderID : selectedNMO, PersonID: this.Person.PersonID};
  ...
  getProgress()
  {
    this.leaderService.getLeaderProgress().subscribe(data=> {this.LeaderProgress = data
        ...
        //Assign leader follow-up progress to array to render chart
         this.pieChartData[0] = this.LeaderProgress.Completed;
         this.pieChartData[1] = this.LeaderProgress.Remaining;
        this.TotalFollowUps = this.LeaderProgress.Completed + this.LeaderProgress.Remaining;
