...
export class FollowUpSalvationComponent implements OnInit {
  ...
  //Code use to generate the chart
  ...
  constructor(private loginService: LoginService, private SalvationService: SalvationServiceService,private memberService: MembersService,  private toastrService: NbToastrService, private router: Router, private sidebarService: NbSidebarService) {
  ...
  ngOnInit(): void {
    ...
    this.SalvationService.getSalvation().subscribe(data=> {this.Salvations = data;
      ...
      this.SalvationService.getSalvationProgress().subscribe(data=> {this.SalvationsProgress = data;
        //Assign salvation progress to array for chart
        this.pieChartData[0] = this.SalvationsProgress.Completed;
        this.pieChartData[1] = this.SalvationsProgress.Remaining;
        this.TotalFollowUps = this.SalvationsProgress.Completed + this.SalvationsProgress.Remaining;
  ...
  {
    var data = { SalID : selectedSalvation, PersonID: this.Person.PersonID};
  ...
  {
    this.SalvationService.getSalvationProgress().subscribe(data=> {this.SalvationsProgress = data
        //Assign salvation progress to array to render chart
        this.pieChartData[0] = this.SalvationsProgress.Completed;
        this.pieChartData[1] = this.SalvationsProgress.Remaining;
        this.TotalFollowUps = this.SalvationsProgress.Completed + this.SalvationsProgress.Remaining;
