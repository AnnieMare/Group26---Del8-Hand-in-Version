...
@Component({
  selector: 'app-new-counselling-view',
  templateUrl: './new-counselling-view.component.html',
  styleUrls: ['./new-counselling-view.component.scss']
})
export class NewCounsellingViewComponent implements OnInit {
